...
public class SudokuArcConsistency {
    ...
    public static void main(String[] args) {
        Scanner in= null;
        /*try {
            in = new Scanner(new File("src/resources/sudoku-"+1+".txt"));
        ...
        ArrayList[][] sudokuCSP = CSPify(sudoku);
        sudokuAC(sudokuCSP);
        printSudoku(sudokuCSP);
    ...
    private static void printSudoku(ArrayList[][] sudoku) {
